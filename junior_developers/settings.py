"""
Django settings for junior_developers project.
...
ROOT_URLCONF = 'junior_developers.urls'
...
WSGI_APPLICATION = 'junior_developers.wsgi.application'
...
MEDIA_SPECIALITY_IMAGE_DIR = 'specialty_images'
